...
const TodoItem: React.FC<ITodoItem> = ({ todo, toggleTodo }) => {
  ...
  return (
    <div className={`${expand ? "h-20 duration-300 ease-in-out" : "h-10 duration-300 ease-in-out"} h-10 w-full p-2 border shadow-md rounded-lg bg-gray-200 bg-opacity-50 font-Inter`}>
