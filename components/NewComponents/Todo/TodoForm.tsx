...
const TodoForm: React.FC<ITodoForm> = ({ createTodo }) => {
  ...
  return (
    <div className="flex items-center space-x-1"> 
        ...
        />
        <button className="p-1 rounded-lg h-9 flex justify-center items-center border-2 bg-gray-200 bg-opacity-50 ease-in-out duration-100 hover:bg-blue-500 hover:text-blue-50 shadow-lg">
          <svg
